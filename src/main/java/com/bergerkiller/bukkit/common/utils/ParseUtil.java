...
public class ParseUtil {
    ...
    private static final Map<String, Boolean> BOOL_NAME_MAP = new HashMap<String, Boolean>(); //may need to be checked on later
    private static final Map<String, Material> MAT_NAME_MAP = new HashMap<String, Material>();
